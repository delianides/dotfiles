...
_G.packer_plugins = {
  ...
  ["lsp-colors.nvim"] = {
    loaded = true,
    path = "/Users/drew/.local/share/nvim/site/pack/packer/start/lsp-colors.nvim"
  },
  ["lsp-status.nvim"] = {
    loaded = true,
