...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-autotag", "nvim-treesitter-textsubjects", "nvim-ts-rainbow", "nvim-ts-context-commentstring" },
...
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'yajs.vim', 'vim-node', 'vim-jsdoc'}, { ft = "javascript" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-cmp', 'nvim-treesitter', 'FixCursorHold.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'trouble.nvim', 'gitsigns.nvim', 'nvim-lspconfig', 'dressing.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
