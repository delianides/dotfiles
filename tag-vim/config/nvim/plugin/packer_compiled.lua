...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-look", "cmp-path", "cmp-nvim-lsp", "nvim-autopairs", "cmp_luasnip", "cmp-buffer", "friendly-snippets" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp-status.nvim", "lua-dev.nvim", "null-ls.nvim", "nvim-lsp-installer", "nvim-lsp-ts-utils" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-lspconfig', 'trouble.nvim', 'nvim-bufferline.lua', 'gitsigns.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
