...
_G.packer_plugins = {
  ...
  ["kanagawa.nvim"] = {
    config = { "\27LJ\2\n“\2\0\0\4\0\6\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0004\3\0\0=\3\4\0024\3\0\0=\3\5\2B\0\2\1K\0\1\0\14overrides\vcolors\1\0\n\17keywordStyle\vitalic\19statementStyle\tbold\14typeStyle\tNONE\25variablebuiltinStyle\vitalic\18specialReturn\2\21specialException\2\16transparent\1\16dimInactive\1\17commentStyle\vitalic\18functionStyle\tNONE\nsetup\rkanagawa\frequire\0" },
    loaded = true,
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-treesitter-textobjects", "nvim-treesitter-textsubjects", "nvim-ts-autotag" },
...
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'vim-node', 'vim-jsdoc', 'yajs.vim'}, { ft = "javascript" }, _G.packer_plugins)]]
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'dressing.nvim', 'gitsigns.nvim', 'trouble.nvim', 'nvim-lspconfig'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
