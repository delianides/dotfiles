...
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'JavaScript-Indent', 'yajs.vim', 'vim-node'}, { ft = "javascript" }, _G.packer_plugins)]]
