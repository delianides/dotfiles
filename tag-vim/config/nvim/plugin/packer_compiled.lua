...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-autopairs", "LuaSnip", "cmp-buffer", "cmp-nvim-lsp", "cmp-path", "cmp_luasnip", "cmp-look", "friendly-snippets" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "playground", "nvim-treesitter-textsubjects", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-cheat.nvim", "telescope-fzy-native.nvim", "telescope-github.nvim", "telescope-symbols.nvim", "telescope-node-modules.nvim", "telescope-packer.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-lspconfig', 'nvim-bufferline.lua', 'trouble.nvim', 'gitsigns.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
