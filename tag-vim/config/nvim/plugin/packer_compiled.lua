...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "nvim-ts-autotag", "nvim-treesitter-textobjects", "nvim-ts-rainbow", "nvim-treesitter-textsubjects" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-cmp', 'FixCursorHold.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
