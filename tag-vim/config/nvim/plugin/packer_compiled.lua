...
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'yajs.vim', 'JavaScript-Indent', 'vim-node'}, { ft = "javascript" }, _G.packer_plugins)]]
