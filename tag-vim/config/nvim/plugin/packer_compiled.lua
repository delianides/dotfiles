...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "friendly-snippets", "cmp-path", "cmp_luasnip", "nvim-autopairs", "cmp-look", "cmp-buffer", "cmp-nvim-lsp", "LuaSnip" },
  ...
  ["nvim-comment"] = {
    ...
    loaded = true,
    path = "/Users/drew/.local/share/nvim/site/pack/packer/start/nvim-comment",
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "null-ls.nvim", "nvim-lsp-ts-utils", "lsp-status.nvim", "nvim-lsp-installer" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textsubjects", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "playground" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-cheat.nvim", "telescope-github.nvim", "telescope-node-modules.nvim", "telescope-packer.nvim", "telescope-fzy-native.nvim", "telescope-symbols.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-lspconfig', 'trouble.nvim', 'gitsigns.nvim', 'nvim-bufferline.lua', 'indent-blankline.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
