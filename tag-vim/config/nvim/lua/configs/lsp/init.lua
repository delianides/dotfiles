...
local function on_attach(client, bufnr)
	...
	if client.name == "typescript" or client.name == "tsserver" then
		-- TODO: set this only for javascript files (*.js)
...
local servers = {
	...
	tsserver = {
		...
		-- 	return util.root_pattern("tsconfig.json")(fname) and util.root_pattern("package.json")(fname)
		-- end,
	},
	cssls = {},
	...
	tailwindcss = {
		root_dir = function(fname)
			return util.root_pattern("tailwind.config.js", "tailwind.config.ts")(fname) -- only if theres a tailwind config
		end,
	},
}
