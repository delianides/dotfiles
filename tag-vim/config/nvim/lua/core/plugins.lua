...
local function plugins(use)
  ...
  use({
      ...
      commit = "0b7433ede19ad507edfaf7a924ee159f271a52c3", -- because I customized it, maybe ill issue a PR
      config = function()
        require("configs.package-info").config()
      end
  })
